    ...
    <div v-else class="footer-section">
      <div v-if="isMobile()" class="mobile-footer-section">
        ...
        <div class="atoa-terms">
          By continuing, you agreed to Atoa’s <a href="https://paywithatoa.co.uk/terms-june-2025/" class="footer-link" target="_blank">Terms</a> and <a href="https://paywithatoa.co.uk/privacy-june-2025/" class="footer-link" target="_blank">Privacy Policy</a>.
        </div>
      </div>
